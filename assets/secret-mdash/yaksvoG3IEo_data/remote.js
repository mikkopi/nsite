...
L:"ytp-mdx-popup-dialog",J:{role:"dialog"},C:[{G:"div",L:"ytp-mdx-popup-dialog-inner-content",C:[{G:"div",L:"ytp-mdx-popup-title",q3:"You're signed out"},{G:"div",L:"ytp-mdx-popup-description",q3:"Videos that you watch may be added to the TV's watch history and influence TV recommendations. To avoid this, cancel and sign in to YouTube on your computer."},{G:"div",L:"ytp-mdx-privacy-popup-buttons",C:[{G:"button",rf:["ytp-button","ytp-mdx-privacy-popup-cancel"],q3:"Cancel"},{G:"button",rf:["ytp-button",
...
break;case -1:this.ip(new g.an(64));break;case -1E3:this.ip(new g.an(128,{errorCode:"mdx.remoteerror",errorMessage:"This video is not available for remote playback.",Wc:2}))}r=iw(this.Ca).trackData;var K=this.S;(r||K?r&&K&&r.trackName==K.trackName&&r.languageCode==K.languageCode&&r.languageName==K.languageName&&r.kind==K.kind:1)||(this.S=r,nFQ(this,r));r=iw(this.Ca);r.volume===-1||Math.round(this.T.getVolume())===r.volume&&this.T.isMuted()===r.muted||this.o1.isActive()||this.qK()}else Lzx(this)};
